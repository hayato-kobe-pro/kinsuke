  ...
  return new Promise(function (resolve, reject) {
    var params = {
      ...
      ProjectionExpression:
        "#id, domain_name, app_id, channel_id, kintone_user_id, kintone_user_code, kintone_user_name, google_refresh_token, google_user_email, kintone_refresh_token, google_calendar_name, google_calendar_id, channel_expires_on, time_zone_user,nextSyncToken",
        ...
        if (Object.keys(dataDb).length > 0) {
          ...
          getAccesstoken(config.google_refresh_token)
            .then(function (res) {
              ...
              var syncToken = config.nextSyncToken;
              var opt = {
                method: "GET",
                headers: {
                  Authorization: "Bearer " + accessToken.access_token,
              ...
              axios(opt)
                .then((response) => {
                  ...
                  var param = {
                    ...
                    UpdateExpression: "set nextSyncToken:=:nextSyncToken",
                    ExpressionAttributeValues: {
